...
A live demo of the project is available at [https://bokepbispak.pages.dev](https://bokepbispak.pages.dev/).
...
-   `SITENAME`: Name of the website (default: `bokep bispak`)
...
```bash
git clone <repo-url> bokepbispak
cd bokepbispak
```
...
1. Fork the [repository](https://github.com/lorountue/bokeppacar) on GitHub.
